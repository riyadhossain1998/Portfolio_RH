...
intro = \
    ...
    "has created this pathway for me to dive into both the Digital Arts and Programming worlds. Thanks to the Milit- I mean, Internet and Social Media and Pop Culture,"\
...
musicsurf = \
    ...
    "course. For this, we conducted ;user research; to learn about competitors, end-user and stakeholder needs. We used ;UX Design Principles; we learned "\
    "in class to ;ideate;, ;brainstorm; and ;prototype; our ideas. We had ;initial sketches;, which turned into ;colored designs; to ;low-fidelity prototypes; "\
...
oms = \
    ...
    "workplace to fulfill online orders and other floor and receiving activities but this project will first focus on ;online order fulfilment;. My goal for this"\
    ...
    "The current designs are just a redesign of the old version, the reason why I did not make a drastic change in UI is because I did not want retail employees"\
    ...
    ";mental health;. With these factors improving, the overall ;customer experience; will surely improve as well."
