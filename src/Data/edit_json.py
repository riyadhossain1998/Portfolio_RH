...
oms = \
    ...
    "workplace to fulfill online orders and other floor and receiving activities but this project will first focus on ;online order fulfilment system;. "\
    "The goal is to improve ;user experience; for ;retail workers; by making it more ;intuitive; and ;easy to use;. "\
        "\n\n"\
